...
# TODO: I need to solve the issue of multiple items being dropped in a chest. Similarly gold drop needs to be unified
location_table = {
	# Mountain Path
	...
	LocationData("MountainPath_North5", 6, "Copper", MonsterSanctuaryLocationCategory.ITEM),  # x2 items
	LocationData("MountainPath_North6", 1, "Tome", MonsterSanctuaryLocationCategory.ITEM),
	LocationData("MountainPath_North6", 2, "Potion", MonsterSanctuaryLocationCategory.ITEM),  # x2 items
	...
	LocationData("MountainPath_Center3", 6, "Phoenix Tear", MonsterSanctuaryLocationCategory.ITEM),  # x3 items
	...
	LocationData("MountainPath_Center5", 13, "Craft Box", MonsterSanctuaryLocationCategory.ITEM),  # x3 items
	...
	LocationData("MountainPath_Center6", 10, "Potion", MonsterSanctuaryLocationCategory.ITEM),  # x2 items
	...
	LocationData("MountainPath_West2", 22, "Smoke Bomb", MonsterSanctuaryLocationCategory.ITEM),  # x3 items
	...
	LocationData("MountainPath_West6", 135, "Apple", MonsterSanctuaryLocationCategory.GIFT),  # x2 items
	LocationData("MountainPath_West6", 136, "Potato", MonsterSanctuaryLocationCategory.GIFT),  # x2 items
