...
class TestLocations_MonsterJournal(MonsterSanctuaryTestBase):
    options = {
        "goal": 2,
        "shopsanity": 1,
        "shops_ignore_rank": 0,
    ...
    def test_keeper_master_locations_exist(self):
        for location in LOCATIONS.keeper_master_locations:
            self.assert_location_exists(location)
...
class TestLocations_Mozzie(MonsterSanctuaryTestBase):
    options = {
        "goal": 3,
        "shopsanity": 1,
        "shops_ignore_rank": 0,
    ...
    def test_velvet_melody_locations_do_not_exist(self):
        for location in LOCATIONS.velvet_melody_locations:
            self.assert_location_does_not_exist(location)
